...
program
  ...
  .action(async (options, cmd) => {
    ...
    try {
      const validatedOptions = commandsConfigSchema.build.parse({
        ...options,
...
program
  ...
  .action(async (options, cmd) => {
    ...
    try {
      const validatedOptions = commandsConfigSchema.clean.parse({
        ...options,
        verbose: globalOptions.verbose,
      });
...
program
  ...
  .action(async (options, cmd) => {
    ...
    try {
      const validatedOptions = commandsConfigSchema.publishStaging.parse({
        ...options,
        verbose: globalOptions.verbose,
      });
